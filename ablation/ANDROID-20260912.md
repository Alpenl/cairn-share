...
Generated: `2026-09-12T06:43:42.523251+00:00`
...
Behavioral detection rate: **15/32 (46.9%)**. Compiler/schema kills are reported separately and are not counted as assertion detection.
...
This report combines the full 32-case JVM/build matrix with the image and pagination device reruns. See the source_reports entries in the JSON. The initial pagination baseline raced an 8-second mock response; that run remains archived separately. The final pagination test holds the second response until the first page has been inspected. Both final device baselines pass before their mutations are applied.
