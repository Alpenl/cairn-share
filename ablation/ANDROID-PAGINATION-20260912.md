...
Generated: `2026-09-12T06:42:20.712567+00:00`
...
| --- | ---: | ---: | ---: | ---: | ---: |
| `android_unit` | PASS | 31 | 31 | 0 | 10.916 |
| `android_build` | PASS | 0 | 0 | 0 | 16.242 |
| `android_device:firstPageIsVisibleBeforeLaterPagesComplete` | PASS | 1 | 1 | 0 | 68.600 |
...
Behavioral detection rate: **1/1 (100.0%)**. Compiler/schema kills are reported separately and are not counted as assertion detection.

## Case Results

| Case | Platform | Area | Result | Tests | Seconds | File |
| --- | --- | --- | --- | ---: | ---: | --- |
| `android-progressive-library` | android | performance | `KILLED_DEVICE` | 0/1 | 79.877 | `android/app/src/main/java/com/alpenl/cairn/share/CairnLinksViewModel.kt` |
